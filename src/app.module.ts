...
import { GoogleDriveConfig } from './managerGoogle/types/googleDriveConfig';
import { GoogleDriveService } from './managerGoogle/services/GoogleDrive.Service';

@Module({
  imports: [
    MyAuthGoogleDriveModule.register({
